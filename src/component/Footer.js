...
export default function Footer() {
  ...
  <div class=" px-6 pt-6">
    <div class="flex justify-center items-center mb-3">
      ...
      <a href="https://www.peerlist.io/snehafarkya/" type="button" class="social rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1 flex justify-center items-center" target={"_blank"}>
      ...
      <a href="https://www.youtube.com/@snhafarkya" type="button" class="social rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1" target={"_blank"}>
        <svg aria-hidden="true"
        focusable="false"
        data-prefix="fab"
        data-icon="Youtube"
          ...
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor" class="bi bi-youtube w-3 h-full mx-auto " viewBox="0 0 16 16"
        >
