      ...
      <footer class="text-center  text-white ">
        <div class=" px-6 pt-6">
          <div class="flex justify-center items-center mb-3">
            <a
              href="https://www.twitter.com/sneha_farkya/"
              type="button"
              class="social rounded-full border-2 border-white dark:border-[#18224b] text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
              target={"_blank"}
            >
              <svg
                aria-hidden="true"
              ...
              >
                <path
                  // fill="white"
                  className="fill-white dark:fill-[#18224b]"
            ...
            <a
              href="https://www.instagram.com/sneha__farkya/"
              type="button"
              class="social rounded-full border-2 border-white dark:border-[#18224b] text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
              target={"_blank"}
            >
            ...
            <a
              href="https://www.peerlist.io/snehafarkya/"
              type="button"
              class="social rounded-full border-2 border-white dark:border-[#18224b] text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1 flex justify-center items-center"
              target={"_blank"}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              href="https://www.youtube.com/@snhafarkya"
              type="button"
              class="social rounded-full border-2 border-white dark:border-[#18224b] text-white leading-normal uppercase hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
              target={"_blank"}
            >
              <svg
                aria-hidden="true"
                ...
                xmlns="http://www.w3.org/2000/svg"
                // className="fill-white dark:fill-[#18224b]"
                class="bi  bi-youtube w-3 h-full mx-auto "
                viewBox="0 0 16 16"
              >
                <path
                className="fill-white dark:fill-[#18224b]"
